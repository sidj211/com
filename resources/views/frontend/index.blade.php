...
{{--<li class="animated_item">{{$categories->name}}<a href="#"></a></li>--}}
{{--@endforeach--}}
{{--@endsection--}}
                ...
                <aside class="col-md-3 col-sm-4 has_mega_menu">
                    ...
                    <div class="section_offset animated transparent" data-animation="fadeInDown">
                        ...
                        <a href="#">
                            ...
                            <img src="/images/mobile1.png" alt="ni aai">
                                ...
                                @foreach($banners as $banner)
                                    <!-- - - - - - - - - - - - - - Slide 1 - - - - - - - - - - - - - - - - -->
                                        ...
                                        <li data-transition="papercut" data-slotamount="7">
                                            ...
                                            <img src="{{URL::to('/')}}/images/{{$banner->file}}" alt=""  style="width:400px;height:300px">
